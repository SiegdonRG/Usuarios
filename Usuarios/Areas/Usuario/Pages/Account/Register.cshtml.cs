...
namespace Usuarios.Areas.Usuario.Pages
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "El número de caracteres {0} debe ser al menos {2}", MinimumLength = 8)]
            public string Password { get; set; }

            [Required]
            [DataType(DataType.Password)]
            [Display(Name = "Confirme contraseña")]
            [Compare("Password", ErrorMessage ="Contraseña no correcta sjjsjssj")]
        ...
        private async Task<bool> RegisterUserAsync()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    Input = new InputModel
                    {
                        ErrorMessage = $"El {Input.Email} ya está registrado owo",
                        Email = Input.Email
                    };
                    _input = Input;
                    run = false;
